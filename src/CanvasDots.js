...
const canvasDots = function () {
    ...
    if (windowSize > 1600) {
      dots = {
        nb: 1100, // number of particles
        distance: 85, // max distance between particles for them to link
        d_radius: 350, // radius from mouse location that particles will link
        array: [],
      };
